...
class Profile(TimeStampedModel):
    ...
    occupation = models.CharField(
        ...
        default=Occupation.TENNANT,
    )
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=20, default="+3305464"
    )
    country_of_origin = CountryField(verbose_name=_("Country"), default="FR")
    city_of_origin = models.CharField(
        verbose_name=_("City"), max_length=100, default="Paris"
    )
